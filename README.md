...
3.  Ask Claude: "Ask Gemini to describe a futuristic city."
4.  **Test Image Generation**:
    - Ask Claude: "Generate an image of a futuristic city."
    - Claude should return an image generated by the `imagen-3.0-generate-001` model.
5.  Check your Instana Dashboard:
    - Go to **Applications** -> **Services**.
    - Look for a service named `gemini-mcp-server`.
    - You should see traces for `ask_gemini` and `generate_image` calls.
